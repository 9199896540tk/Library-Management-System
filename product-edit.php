            ...
            <div class="card-body">
              ...
              <form class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <input value="<?php echo $rs['price'] ?>" type="text" class="form-control" id="price" name="price" placeholder="Enter price">
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">Quantity</label>
                  <input value="<?php echo $rs['quantity'] ?>" type="text" class="form-control" id="quantity" placeholder="Enter quantity">
                </div>
